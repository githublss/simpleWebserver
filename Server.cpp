...
char INDEX_PAGE[] = "<!DOCTYPE html>\n"
                    "<html>\n"
                    "<head>\n"
                    "    <title>Welcome to LSS WebServer!</title>\n"
                    "    <style>\n"
                    "        body {\n"
                    "            width: 35em;\n"
                    "            margin: 0 auto;\n"
                    ...
                    "</head>\n"
                    "<body>\n"
                    "<h1>Welcome to LSS WebServer!</h1>\n"
                    "<p>If you see this page, the lss webserver is successfully installed and\n"
                    "    working. </p>\n"
                    "\n"
                    "<p>For online documentation and support please refer to\n"
                    "    <a href=\"https://github.com/githublss/simpleWebserver\">lss WebServer</a>.<br/>\n"
                    "\n"
                    "<p><em>Thank you for using LSS WebServer.</em></p>\n"
                    "    <h1 align=\"center\"><a href=\"/index.html\" > Here's a little app of mine </a></h1><br/>\n"
                    "</body>\n"
                    "</html>";
